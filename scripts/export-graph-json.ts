...
try {
	...
	const payload = { generatedAt: new Date().toISOString(), source: dbPath, graphFilters, sessions, edges, labels, classifications, logicalThreads, threadMembers, threadEdges, threadResumeTargets, repoIdentities, repoObservations, repoEvents, compactionEvents, workBursts, temporalActivitySpans, activityMetrics };
