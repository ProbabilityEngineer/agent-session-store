...
function stableId(stableName) { return `repo_identity_${stableName.toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/^-|-$/g, "")}`; }
...
let evidence = { source: "manual-approval" };
if (candidateId) {
...
if (!stableName || !displayName || paths.length < 1)
    usage();
if (!flag("--yes")) {
...
//# sourceMappingURL=approve-repo-identity.js.map